...
rem ************************************************************
rem *                                                          *
rem *                     FlowHooks - All Rights Reserved      *
rem *              (c) 2019-2025 FlowHooks Software LTDA.     *
rem *                                                          *
rem *  This software is proprietary.                           *
rem *  Unauthorized use, reproduction, or distribution is      *
rem *  strictly prohibited.                                     *
rem *                                                          *
rem *  Author: Felipe Cezar Paz (git@felipecezar.com)          *
rem *  File:                                                  *
rem *  Description:                                            *
rem *                                                          *
rem ************************************************************
